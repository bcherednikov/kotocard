...
export default function PrimaryTestPage() {
  ...
  function prepareQuestion(card: UserCardWithCard, deckCards: CardData[]) {
    ...
    switch (testType) {
      case 'choice':
        question = generateChoiceQuestion(cardData, deckCards);
        break;
      case 'audio':
        question = generateAudioQuestion(cardData, deckCards);
        break;
      case 'dictation':
        question = generateDictationQuestion(cardData);
        break;
    }
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-gray-700 mb-6">
            Сначала просмотри карточки и отметь «Знаю»
          </p>
          <Link
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-lg font-semibold text-gray-800">
            {currentIndex + 1} из {testCards.length}
          </div>
        ...
        {showFeedback && currentQuestion && (
          <TestFeedback
            ...
            correctAnswer={currentQuestion.type === 'dictation' ? currentQuestion.correctAnswer : currentQuestion.correctAnswer}
